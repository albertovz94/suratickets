<div wire:poll.5s="updateCount" class="relative" x-data="{ open: false }">
    <button @click="open = !open" class="relative p-2 text-suraki-primary hover:text-red-800 focus:outline-none focus:ring-2 focus:ring-suraki-primary focus:ring-offset-2 focus:ring-offset-suraki-secondary rounded-full transition-colors duration-150">
    ...
    <div x-show="open" @click.away="open = false" style="display: none;" class="absolute right-0 md:-right-4 lg:-right-8 z-50 mt-2 w-96 origin-top-right rounded-xl bg-white py-1 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none animate-fade-in" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
