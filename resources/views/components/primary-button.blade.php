...
@if ($href)
    <a href="{{ $href }}" {{ $attributes->merge(['class' => 'blob-btn inline-flex items-center justify-center font-semibold text-xs uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-suraki-primary focus:ring-offset-2 shadow-sm']) }}>
