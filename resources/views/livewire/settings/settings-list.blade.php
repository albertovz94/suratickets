        ...
        <div class="bg-white/80 backdrop-blur-xl overflow-hidden shadow-sm sm:rounded-2xl border border-white/50 p-6">
            ...
            <div>
                <div class="flex justify-end mb-4">
                    <button wire:click="openDepartmentModal" class="px-4 py-2 bg-suraki-primary hover:bg-suraki-primary-hover text-white rounded-lg text-sm font-bold shadow-sm transition-colors">
                        + Nuevo Departamento
                    </button>
                </div>
            ...
            <div>
                <div class="flex justify-end mb-4">
                    <button wire:click="openBranchModal" class="px-4 py-2 bg-suraki-primary hover:bg-suraki-primary-hover text-white rounded-lg text-sm font-bold shadow-sm transition-colors">
                        + Nueva Sucursal
                    </button>
                </div>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="saveDepartment" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-suraki-primary text-base font-medium text-white hover:bg-suraki-primary-hover sm:ml-3 sm:w-auto sm:text-sm">Guardar</button>
    ...
    <div class="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="saveBranch" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-suraki-primary text-base font-medium text-white hover:bg-suraki-primary-hover sm:ml-3 sm:w-auto sm:text-sm">Guardar</button>
