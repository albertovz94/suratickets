                            ...
                            @forelse ($users as $user)
                                <tr class="hover:bg-suraki-neutral/20 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @endphp
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold {{ $stateClasses[$user->status] ?? $stateClasses['Inactivo'] }}">
                                            <span class="w-1.5 h-1.5 rounded-full {{ $dotClasses[$user->status] ?? $dotClasses['Inactivo'] }}"></span>
                                            {{ $user->status }}
                                        </span>
                                    </td>
