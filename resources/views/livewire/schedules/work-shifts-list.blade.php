        ...
        <div class="lg:col-span-1">
            <form wire:submit="createShift" class="bg-white rounded-2xl shadow-sm border border-suraki-neutral-dark p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="date" wire:model="date" min="{{ \Carbon\Carbon::today()->format('Y-m-d') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-suraki-primary focus:ring-suraki-primary bg-gray-50 text-sm" required>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="time" wire:model="scheduled_start" max="22:30" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-suraki-primary focus:ring-suraki-primary bg-gray-50 text-sm">
                    ...
                    <div>
                        ...
                        <input type="time" wire:model="scheduled_end" max="22:30" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-suraki-primary focus:ring-suraki-primary bg-gray-50 text-sm">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @if($shift->status === 'programado')
                                            @if($shift->date->isToday() || auth()->user()->hasAdminAccess())
