...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <button @click="open = !open" class="flex items-center gap-3 focus:outline-none hover:bg-suraki-neutral p-1.5 rounded-xl transition-colors duration-200">
        ...
        <div class="text-left hidden md:block">
            ...
            <p class="text-xs text-suraki-tertiary mt-1 font-mono lowercase">{{ auth()->user()->role }}</p>
        </div>
    ...
    <div x-show="open" 
        ...
        <div class="py-2">
            ...
            <button wire:click="logout" x-on:click="window.useLoading().show('Cerrando sesión...', 6000)" class="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-bold text-red-600 hover:bg-red-50 transition-colors">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
